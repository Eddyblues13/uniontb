...
var Theme = function() {
        ...
        return _createClass(t, [{
            ...
            value: function() {
                (this.isIE() || this.isEdge()) && $([".user-avatar img", ".tile > img", ".figure-attachment > img", ".page-cover > .cover-img", ".list-group-item-figure > img"].toString()).each(function() {
                    var e = $(this),
                        t = e.prop("src"),
                        a = e.parent();
            ...
            value: function() {
                $(document).on("click", 'a.smooth-scroll[href^="#"]', function(e) {
                    var t, a, i = $(this).attr("href"),
                        o = $(i);
                    o.length && (e.preventDefault(), t = $(".app-header").height() + 20, a = o.offset().top - t, $("html, body").animate({
                        scrollTop: a < 0 ? 0 : a
                    }, 700))
                })
            }
            ...
            value: function() {
                var e, t, a, i;
                window.Chart && (e = this.colors, t = "dark" === this.skin, a = this.getColors("gray"), i = {
                    global: {
                        responsive: !0,
            ...
            value: function() {
                var t;
                $.fn.easyPieChart && (t = this, $('[data-toggle="easypiechart"]').each(function() {
                    var e = $(this).data();
            ...
            value: function() {
                var t;
                $.fn.knob && (t = this, $('[data-toggle="knob"]').each(function() {
                    var e = $(this).data();
            ...
            value: function() {
                window.vanillaTextMask && $("[data-mask]").each(function() {
                    ...
                    t.inputElement = this, t.mask = {
                        ...
                        expdatecc: [/\d/, /\d/, "/", /\d/, /\d/],
                        cvc: [/\d/, /\d/, /\d/]
                    }[t.mask] || [], t.placeholderChar = t.placeholderChar || "#", "cazip" == a ? t.pipe = function(e) {
                        return e.toUpperCase()
                    } : "email" == a ? t.mask = textMaskAddons.emailMask || [] : "currency" == a ? (t.prefix = t.prefix || "", t.mask = textMaskAddons.createNumberMask ? textMaskAddons.createNumberMask(t) : []) : "percentage" == a && (t.prefix = "", t.suffix = "%", t.mask = textMaskAddons.createNumberMask ? textMaskAddons.createNumberMask(t) : []), t.autoCorrectDate && (e = textMaskAddons.createAutoCorrectedDatePipe ? textMaskAddons.createAutoCorrectedDatePipe(t.autoCorrectDate) : null, t.pipe = e), vanillaTextMask.maskInput(t)
                })
            }
        }, {
            key: "headroom",
