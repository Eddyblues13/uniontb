		...
		<center>
			<table>
				<tr>
					...
					<td style="font-size:9pt;text-align:center;">
						<a class="" href="{{route('admin.cheque-deposits.index')}}" style="margin-right:10px">
							<img src="{{asset('user/icon/Copy Trader.png')}}" style="width:20px;height:20px"><br>Check
							Deposits</a>
					</td>

					<td style="font-size:9pt;text-align:center;"> <a class="" href="{{route('admin.transfers.index')}}"
